...
from bot.utils import save_voice_as_mp3, audio_to_text, get_response_from_openai, text_to_speech, new_session
...
async def process_voice_message(message: Message, bot: Bot):
    ...
    answer = await get_response_from_openai(user_id, transcripted_voice_text)  # получение ответа от гпт
